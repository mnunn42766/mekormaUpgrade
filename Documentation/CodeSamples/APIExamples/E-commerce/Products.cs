    ...
    internal class ProductsMain
    {
        ...
        private class ProductPages
        {
            ...
            private void CreateProductDocument()
            {
                ...
                TreeNode parent = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Products", TreeProvider.ALL_CULTURES, true, SystemDocumentTypes.MenuItem);
                ...
                if ((parent != null) && (product != null))
                {
                    ...
                    node.DocumentSKUName = "NewProduct";
            ...
            private void GetAndUpdateProductDocument()
            {
                ...
                SKUTreeNode node = (SKUTreeNode)tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Products/NewProduct", null, true);
            ...
            private void DeleteProductDocument()
            {
                ...
                // Gets the product page
                TreeNode node = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Products/NewProduct", null, true);
        ...
        /// <summary>
        /// Holds donation product API examples.
        /// </summary>
        /// <groupHeading>Donation products</groupHeading>
        private class DonationProducts
        {
            /// <heading>Creating a donation</heading>
            private void CreateDonation()
            {
                ...
                // Sets the product properties (e.g. marks the product as a donation)
                if (department != null)
                {
                    newProduct.SKUDepartmentID = department.DepartmentID;
                }
                newProduct.SKUName = "NewDonationProduct";
                newProduct.SKUPrice = 169;
                newProduct.SKUEnabled = true;
                newProduct.SKUSiteID = SiteContext.CurrentSiteID;
            ...
            /// <heading>Deleting donations</heading>
            private void DeleteDonation()
            {
                // Gets all donation products whose names starts with 'New'
                var products = SKUInfoProvider.GetSKUs()
                                       .WhereStartsWith("SKUName", "New")
                                       .WhereEquals("SKUProductType", SKUProductTypeEnum.Donation);

                // Loops through the donation products
                foreach (SKUInfo deleteProduct in products)
                {
                    // Deletes the donation product
                    SKUInfoProvider.DeleteSKUInfo(deleteProduct);
                }
            }
        }
