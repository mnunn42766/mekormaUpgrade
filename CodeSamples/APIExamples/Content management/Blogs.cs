    ...
    internal class Blogs
    {
        ...
        private class Blog
        {
            ...
            private void CreateBlog()
            {
                ...
                TreeNode parentPage = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Blogs", "en-us");
            ...
            private void GetAndUpdateBlog()
            {
                ...
                // Gets the blog page
                TreeNode blogPage = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Blogs/NewBlog", "en-us");
        ...
        private class BlogPosts
        {
            ...
            private void CreateBlogPost()
            {
                ...
                TreeNode parentBlog = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Blogs/NewBlog", "en-us");
