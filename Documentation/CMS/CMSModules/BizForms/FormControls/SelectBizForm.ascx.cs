...
public partial class CMSModules_BizForms_FormControls_SelectBizForm : FormEngineUserControl
{
    ...
    protected void NameAssignment(TextBoxControl PartnerFName, TextBoxControl TextBoxControl_1, TextBoxControl PartnerLName ,TextBoxControl TextBoxControl)
    {

       TextBoxControl_1.Value = PartnerFName.Value ;
        TextBoxControl.Value = PartnerLName.Value;
    }
    /// <summary>
