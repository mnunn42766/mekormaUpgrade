    ...
    internal class Pages
    {
        ...
        private class PageCreation
        {
            ...
            private void CreateNewCultureVersion()
            {
                ...
                TreeNode page = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Articles/Coffee-Beverages-Explained", "en-us");
            ...
            private void CreateLinkedPage()
            {
                ...
                TreeNode originalPage = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Archive/Articles", "en-us");

                // Gets the page that will be used as a parent page for the linked page
                TreeNode parentPage = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Articles/", "en-us");
        ...
        private class PageManagament
        {
            ...
            private void UpdatingPagesAndUpdatingSearchTasks()
            {
                ...
                // Gets an existing page in the "en-us" culture
                TreeNode page = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Article/Coffee-Beverages-Explained", "en-us");
            ...
            private void CopyingPages()
            {
                ...
                TreeNode targetPage = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Archive", "en-us");
        ...
        private class PageDeletion
        {
            ...
            private void DeletingPages()
            {
                ...
                TreeNode page = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/Articles/On-Roasts", "en-us");
