    ...
    internal class EventsMain
    {
        ...
        private class Events
        {
            ...
            private void GetAndUpdateEvent()
            {
                ...
                // Gets the event page
                TreeNode node = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/NewPage/NewEvent", null, true);
            ...
            private void DeleteEvent()
            {
                ...
                // Gets the event page
                TreeNode eventNode = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/NewPage/NewEvent", null, true);

                // Gets the parent page of the event
                TreeNode node = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/NewPage", null, true);
