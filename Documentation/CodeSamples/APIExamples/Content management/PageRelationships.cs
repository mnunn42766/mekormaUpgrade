        ...
        private class PageRelationships
        {
            ...
            private void CreateRelationship()
            {
                ...
                if (relationshipName != null)
                {
                    ...
                    TreeNode firstPage = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/FirstPage", "en-us");
                    TreeNode secondPage = tree.SelectSingleNode(SiteContext.CurrentSiteName, "/SecondPage", "en-us");
